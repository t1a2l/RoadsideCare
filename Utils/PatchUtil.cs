...
namespace RoadsideCare.Utils
{
    ...
    {
        private const string HarmonyId = "t1a2l.RoadsideCare";
        ...
        public static void PatchAll()
        {
            ...
            UnityEngine.Debug.Log("Roadside Care: Patching...");

            patched = true;

            // Apply your patches here!
            // Harmony.DEBUG = true;
            var harmony = new Harmony("t1a2l.RoadsideCare");
        ...
        public static void UnpatchAll()
        {
            ...
            UnityEngine.Debug.Log("Roadside Care: Reverted...");
        }
    }
