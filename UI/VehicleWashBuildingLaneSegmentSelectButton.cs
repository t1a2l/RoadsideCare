...
{
    public class VehicleWashBuildingLaneSegmentSelectButton : UIButton
    {
        ...
        public override void Start()
        {
            ...
            {
                SegmentSelectionTool.ToggleTool(BuildingID, true);
            };
        ...
        public override void Update()
        {
            ...
            if (BuildingId != 0)
            {
                ...
                if (building.Info.GetAI() is VehicleWashBuildingAI && VehicleWashBuildingManager.VehicleWashBuildingExist(BuildingId))
                {
